...
const BOOLEAN_KEYS = new Set([
  ...
  'oledBlack', 'epgLazyLoadingEnabled', 'disableEpgTransitions', 'epgReduceGpuLayers',
  'epgDisableChannelFade', 'epgPreferEpgLogos', 'logoSmartTrim', 'logoLightBackgroundDetection',
