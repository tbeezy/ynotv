...
import type { ShortcutsMap, ShortcutAction } from '../../types/electron';
...
const ACTION_LABELS: Record<ShortcutAction, string> = {
    ...
    cycleSubtitle: 'Cycle Subtitles',
    cycleAudio: 'Cycle Audio Track',
...
const GROUPS: Record<string, ShortcutAction[]> = {
    'Playback': ['togglePlay', 'seekForward', 'seekBackward', 'toggleMute', 'cycleSubtitle', 'cycleAudio'],
    'Interface': ['toggleGuide', 'toggleCategories', 'toggleStats', 'close']
};
